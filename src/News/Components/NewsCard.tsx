...
export const NewsCard = ({id,autor,title,fecha,urlImage}:props) => {
  ...
  return (
    <Link  to={`/news/${id}`} className="bg-white cursor-pointer hover:scale-[1.01] rounded-lg shadow-md w-full px-1 py-3 border-2 flex flex-col gap-1 items-center justify-center">
